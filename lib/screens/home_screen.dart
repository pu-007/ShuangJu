...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _selectRandomShowAndQuote() {
    ...
    if (notifier.tvShows.isNotEmpty) {
      ...
      print(
        "[HomeScreen] Selecting random show. Notifier has ${notifier.tvShows.length} shows.",
      ); // Added Log
      setState(() {
        _currentShow = selectedShow;
        _currentQuote = selectedQuote;
        print(
          "[HomeScreen] Selected show: ${selectedShow.name}, Quote: $selectedQuote",
        ); // Added Log
      });
    } else {
      print(
        "[HomeScreen] Cannot select random show. Notifier has ${notifier.tvShows.length} shows.",
      ); // Added Log
    }
  }
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          Positioned(
            bottom:
                80, // Adjust position to leave space for potential bottom controls/nav
            left: 20,
            right: 20,
            child: Column(
          ...
          AnimatedPositioned(
            ...
            top:
                _isExpanded
                    ...
                    : -(MediaQuery.of(
                      context,
                    ).size.height), // Animate off-screen
            left: 10,
            right: 10,
            child: Material(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              '观看记录 (${_currentShow!.progress.current} / ${_currentShow!.progress.total})',
            ),
          ),
          ...
          Row(
            ...
            children: [
              IconButton(
                ...
                tooltip: '减少进度',
                onPressed:
                    (_currentShow!.progress.current <= 0)
                        ? null
                        : () {
                          // Disable if already 0
              ...
              IconButton(
                ...
                tooltip: '增加进度',
                onPressed:
                    (_currentShow!.progress.current >=
                            _currentShow!.progress.total)
                        ? null
                        : () {
                          // Disable if already max
                          final current = _currentShow!.progress.current + 1;
                          Provider.of<TvShowNotifier>(
                            context,
                            listen: false,
          ...
          TextButton.icon(
            ...
            onPressed: () {
              /* TODO: Show thoughts dialog/screen */
              print('想法 tapped');
            },
          ),
        ],
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext ctx) {
        ...
        final double maxHeight =
            MediaQuery.of(ctx).size.height * 0.6; // 60% of screen height
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Flexible(
                  // Make the ListView flexible within Column
